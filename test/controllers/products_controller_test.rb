...
class ProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'render a list of products filtered by min_price and max_price' do
    get products_path(min_price: 100, max_price:300)
  ...
  test 'allow to create a new product' do
    post products_path, params: {
      product: {
        title: 'Nitendo 64',
        description: 'Algun dia la tendre de coleccion',
        price: 50,
    ...
    assert_equal flash[:notice], 'Tu Producto se ah creado correctamente'
  end
  ...
  test 'allow to update a product' do
    ...
    assert_redirected_to products_path
    assert_equal flash[:notice], 'Tu Producto se ah actualizado correctamente'
  end
